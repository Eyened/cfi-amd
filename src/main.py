...
features_names = 'drusen', 'RPD', 'hyperpigmentation', 'rpe_degeneration'
...
def main(csv_path, output_folder, args):
    ...
    for idx, row in df.iterrows():
        ...
        export_features(result, base_path, args.export_probability, args.skip_empty)
        ...
        report.export(base_path, image, row.identifier, args.export_html_report, True)
